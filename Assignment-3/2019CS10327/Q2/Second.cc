...
main (int argc, char *argv[])
{
  ...
  std::string cwndFileName = "cr_8_ar_1.cwnd";
  std::string pckDropFileName = "cr_8_ar_1.pcap";
  if (argc>2){
      channelDataRate = argv[1];
      appDataRate = argv[2];
      channelDataRate += "Mbps";
      appDataRate += "Mbps";
      cwndFileName = "cr_"+channelDataRate+"_ar_"+appDataRate+".cwnd";
      pckDropFileName = "cr_"+channelDataRate+"_ar_"+appDataRate+".pcap";
  }
